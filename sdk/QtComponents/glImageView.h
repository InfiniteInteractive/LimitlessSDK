...
public:
    GLImageView(QWidget *parent, GLImageView *masterWidget=NULL);
    GLImageView(QGLContext *context, QWidget *parent);
    ~GLImageView();
    ...
    void attachViewer(GLImageView *glViewer);
    void removeViewer(GLImageView *glViewer);
    void notify();
...
protected:
    ...
    void setMasterWidget(GLImageView *master);
